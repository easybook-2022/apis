...
@app.route("/insert_real_into_table/<locationId>")
def insert_real_into_table(locationId):
	list = [
		{
			"menuName": "Mon Khai Vi - Appetizers",
			"meals": [
				{ "number": "100", "name": "BÒ TÁI CHANH", "price": "17.90", "description": "Beef Ceviche in Lime Juice Selag" },
				...
				{ "number": "108", "name": "GỎI NGÓ SEN TÔM THỊT", "description": "Lotus Root with Pork and Shrimp Salad (Spicy and Peanut)", "quantities": [{ "input": "4 Rolls", "price": "12.90" }] },
		...
		},
		{
			...
			"meals": [
				...
				{ "number": "201", "name": "PHỞ ĐẶC BIỆT “I LOVE PHO“", "description": "\"I Love Pho\" Special Rice Noodle Soup", "sizes": [{ "name": "Medium", "price": "13.00" }, { "name": "Large", "price": "15.00" }] },
		...
		},
		{
			...
			"meals": [
				...
				{ "number": "308", "name": "HỦ TIÊU MỸ THO ĐẶC BIỆT", "description": "\"My Tho\" House Special Noodle Soup (with soup or dry)", "sizes": [{ "name": "Medium", "price": "13.45" }, { "name": "Large", "price": "14.45" }] },
				{ "number": "309", "name": "HỦ TIÊU MỸ THỌ ĐÔ BIỀN", "description": "\"My Tho Seafood w/Transparent Noodle Soup (with soup or dry)", "sizes": [{ "name": "Medium", "price": "13.45" }, { "name": "Large", "price": "14.45" }] },
				{ "number": "310", "name": "MI BÒ KHO", "description": "Beef Stewed with Egg Noodle Soup", "sizes": [{ "name": "Medium", "price": "12.90" }, { "name": "Large", "price": "13.90" }], "image": "310.png"},
		...
		},
		{
			...
			"meals": [
				...
				{ "number": "431", "name": "BÚN HOẬC CƠM CÀ RI GÀ", "description": "Curry Chicken with Vermicelli or Steamed Rice", "sizes": [{ "name": "Medium", "price": "12.45" }, { "name": "Large", "price": "13.90" }]}
			]
		},
		{
		...
		},
		{
			...
			"meals": [
				...
				{ "number": "531", "name": "CƠM TÔM XÀO SẢ ỚT", "description": "Stir Fried Shrimp with Lemon Grass & Hot Pepper on Steamed Rice (Spicy)", "price": "16.90" },
				{ "number": "532", "name": "CƠM MỰC XÀO SẢ ỚT", "description": "Stir Fried Squid with Lemon Grass & Hot Pepper on Steamed Rice (Spicy)", "price": "16.45" },
				{ "number": "533", "name": "CƠM BÒ XÀO SATÉ", "description": "Stir Fried Beef with Satay Sauce on Steamed Rice (Spicy)", "price": "15.90" },
				{ "number": "534", "name": "CƠM GÀ XÀO SATÉ", "description": "Sur Fried Chicken with Satay Sauce on Steamed Rice (Spicy)", "price": "15.90" },
				{ "number": "535", "name": "CƠM TÔM XÀO SATÉ", "description": "Stir Fried Shrimp with Satay Sauce on Steamed Rice (Spicy)", "price": "16.90" },
				{ "number": "536", "name": "CƠM MỰC XÀO SATÉ", "description": "Stir Fried Squid with Satay Sauce on Steamed Rice (Spicy)", "price": "16.45" },
				{ "number": "537", "name": "CƠM GÀ XÀO THÁI LAN", "description": "\"Thai Style\" Stir Fried Chicken with Steamed Rice (Spicy)", "price": "15.90" },
				{ "number": "538", "name": "CƠM BỎ XÀO THÁI LAN", "description": "\"Thai Style\" Stir Fried Beef with Steamed Rice (Spicy)", "price": "15.90" },
				{ "number": "539", "name": "CƠM TÔM XÀO THÁI LAN", "description": "\"Thai Style\" Stir Fried Shrimp with Steamed Rice (Spicy)", "price": "16.90" },
				{ "number": "540", "name": "CƠM MỰC XÀO THÁI LAN", "description": "\"Thai Style\" Stir Fried Squid with Steamed Rice (Spicy)", "price": "16.45" },
				{ "number": "541", "name": "CƠM BÒ LÚC LÁC", "description": "Fried Sautéed Cubes of Beef with Steamed Rice", "price": "16.90" }
			]
		},
		{
			...
			"meals": [
				...
				{ "number": "547", "name": "CƠM CHIÊN ĐỒ BIỀN", "description": "Seafood on Fried Rice", "price": "15.90" },
		...
		},
		{
			...
			"meals": [
				{ "number": "N01", "name": "CÀ PHÊ SỮA ĐÁ", "description": "Iced Coffee with Condensed Milk", "price": "5.00" },
				{ "number": "N02", "name": "CÀ PHÊ ĐEN ĐÁ", "description": "Black Iced Coffee", "price": "5.00" },
				{ "number": "N03", "name": "CHÈ 3 MÀU", "description": "Three Kinds of Mung Bean with Coconut Milk", "price": "5.50" },
				{ "number": "N04", "name": "SINH TỐ BỔ", "description": "Avocado Milk Shake", "price": "5.50" },
				{ "number": "N05", "name": "SINH TỐ DÂU", "description": "Strawberry Milk Shake", "price": "5.50" },
				{ "number": "N06", "name": "SINH TỐ XOÀI", "description": "Mango Milk Shake", "price": "5.50" },
				{ "number": "N07", "name": "SINH TỐ MÍT", "description": "Jack Fruit Milk Shake", "price": "5.50" },
				{ "number": "N08", "name": "SINH TỐ SÂU RIÊNG", "description": "Durian Milk Shake", "price": "6.00" },
				{ "number": "N09", "name": "SINH TỐ ĐẬU XANH", "description": "Green Bean Milk Shake", "price": "5.50" },
				{ "number": "N10", "name": "SINH TÔ ĐẬU ĐEN", "description": "Red Bean Milk Shake", "price": "5.50" },
				{ "number": "N11", "name": "SINH TỐ DỪA TƯƠI", "description": "Coconut Milk Shake", "price": "5.50" },
				{ "number": "N12", "name": "SINH TÔ DỪA TƯƠI, ĐẬU ĐEN", "description": "Coconut Mixs with Red Bean Milk Shake", "price": "6.50" },
				{ "number": "N13", "name": "NƯỚC DỪA TƯƠI", "description": "Fresh Coconut Juice", "price": "5.50" },
				{ "number": "N14", "name": "NƯỚC TRÁI VẢI", "description": "Lychee with Ice", "price": "5.50" },
				{ "number": "N15", "name": "SODA CHANH MUỐI", "description": "Salted Lime Juice with Soda", "price": "5.50" },
				{ "number": "N16", "name": "SODA CHANH TƯƠI", "description": "Fresh Lime Juice with Soda", "price": "5.50" },
				{ "number": "N17", "name": "SODA XÍ MUQI", "description": "Picked Plums with Soda", "price": "5.50" },
				{ "number": "N18", "name": "SINH TÔ MÀNG CẦU", "description": "Soursop Smoothie", "price": "5.50" },
