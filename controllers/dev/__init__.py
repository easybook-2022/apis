...
def insert_real_into_table():
	...
	query("delete from menu where id > 10")

	query("alter table product auto_increment = 1")
	query("alter table menu auto_increment = 11")
	...
	list = [
		{
			...
			"meals": [
				...
				{ "name": "CHẢ MỰC CHIẾN", "description": "Deep Fried Squid Cake", "quantities": [{ "input": "4 Rolls", "price": "16.90" }], "image": {"name": "113.png", "width": 910, "height": 910}},
				{ "name": "MỰC KHOANH VÀ KHOAI TÂY TÂM BỘT CHIÊN GIÒN", "description": "Calamari with Wedge Fried Pototes", "quantities": [{ "input": "4 Rolls", "price": "14.90" }], "image": {"name": "114.png", "width": 1404, "height": 1404}},
				{ "name": "TÔM VÀ KHOAI TÂY TÂM BỘT CHIÊN GIÒN", "description": "Shrimp Popcom with Wedges Fried Potatoes", "quantities": [{ "input": "4 Rolls", "price": "16.90" }], "image": {"name": "114A.png", "width": 1155, "height": 1155}},
		...
		},
		{
			...
			"meals": [
				...
				{ "name": "MI BO KHO", "description": "Beef Stewed with Egg Noodle Soup", "sizes": [{ "name": "Medium", "price": "12.90" }, { "name": "Large", "price": "13.90" }], "image": {"name": "310.png", "width": 3953, "height": 3953} },
		...
		},
		{
			...
			"meals": [
				...
				{ "name": "MÌ XÀO GIÒN ĐỘ BIÊN (ONE SIZE)", "description": "Thick Lay of Fired Egg Noodle Top with Seafood & Veg", "price": "17.45", "image": {"name": "318.png", "width": 1837, "height": 1837}},
				{ "name": "HỦ TIÊU XÀO THỊT BÒ (ONE SI", "description": "Stir Fried Rice Noodle with Beef", "price": "15.90" },
				{ "name": "PAD THAI BO (ONE SIZE)", "description": "Beef Pad Thai (Spicy and Peanut)", "price": "15.90", "image": {"name": "320.png", "width": 1509, "height": 1509}},
		...
		},
		{
			...
			"meals": [
				...
				{ "name": "COM TAM 4 MAU", "description": "Grilled Chicken, Grilled Pork Chop, Steamed Egg. Fried Egg on Steamed Broken Rice", "price": "14.45", "image": {"name": "523.png", "width": 1453, "height": 1453}}
			]
		},
		{
		...
		},
		{
			...
			"meals": [
				{ "name": "CƠM CHIẾN GÀ NƯỚNG", "description": "Grilled Chicken on Fried Rice", "price": "15.90", "image": {"name": "542.png", "width": 1749, "height": 1749}},
		...
		},
		{
			...
			"image": {"name": "beersandliquor.png", "width": 3019, "height": 3019},
			"menus": [
				{
	...
	def iterateList(list, pIndex, pId):
		for index, info in enumerate(list):
			...
			if "image" in info:
				...
				sql += "'{\"name\":\"" + image["name"] + "\", \"width\": " + str(image["width"]) + ", \"height\": " + str(image["height"]) + "}'"
			else:
