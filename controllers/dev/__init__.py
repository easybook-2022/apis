...
def create_test_info():
	...
	products = query("select image from product where locationId = " + locationid, True).fetchall()
	menus = query("select image from menu where locationId = " + locationid, True).fetchall()
	...
	query("delete from product where locationId = " + locationid)
	query("delete from menu where locationId = " + locationid)
	...
	location = query("select owners, info from location where id = " + locationid, True).fetchone()
	...
	query("update location set logo = '" + logo + "', info = '" + json.dumps(info) + "' where id = " + locationid)
